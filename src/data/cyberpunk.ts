...
export const ROLES: Record<RoleKey, RoleDef> = {
  ...
  MedTech: {
    ...
    skills: {
      ...
      "Premiers secours": 5,
      Psychologie: 6,
      "Résistance à la torture/aux drogues": 6,
      "Tir automatique": 6,
    },
  },
  Techie: {
    ...
    skills: {
      ...
      Composition: 3,
      Concentration: 6,
      "Conduite de véhicule terrestre": 3,
      "Connaissance de la rue": 4,
      Connaissance: 2,
      Conversation: 2,
      Crochetage: 2,
      ...
      Déduction: 6,
      Discrétion: 6,
      "Dissimulation/Révélation d'objet": 3,
      Esquive: 5,
      "Habillement et style": 3,
      Négoce: 5,
      Perception: 6,
      Persuasion: 1,
      Pistolet: 6,
  ...
  Fixer: {
    ...
    skills: {
      ...
      "Premiers secours": 6,
      Psychologie: 6,
      "Résistance à la torture/aux drogues": 4,
    },
  },
  Rockeur: {
    description:
  ...
  Pilote: {
    ...
    skills: {
      ...
      Danse: 2,
      Discrétion: 4,
      "Dissimulation/Révélation d'objet": 5,
      Esquive: 6,
      "Habillement et style": 3,
      Interrogatoire: 3,
      Perception: 3,
